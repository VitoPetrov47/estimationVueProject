<template>
  <div class="card-content">
    <label class="card-text">Authentication</label>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const authOption = ref([
      { id: 1, label: 'Additional Roles', param: false },
      { id: 2, label: 'OAuth', param: false },
      { id: 3, label: 'Auth0', param: false },
      { id: 4, label: 'Two Factor', param: false },
      { id: 5, label: 'OTP', param: false },
    ]);
    ...
    const selectOption = option => {
      ...
      // console.log('selectedOptions:', JSON.stringify(selectedOptions.value, null, 2));
    };
