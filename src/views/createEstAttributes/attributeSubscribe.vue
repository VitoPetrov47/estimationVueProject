<template>
  <div class="card-content">
    <label class="card-text">Subscribe</label>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const authOption = ref([
      { id: 1, label: 'Триал', param: false },
      { id: 2, label: 'Простые ограничения', param: false },
      { id: 3, label: 'Средние ограничения', param: false },
      { id: 4, label: 'Сложные ограничения', param: false },
    ]);
