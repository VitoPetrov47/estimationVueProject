<template>
  <div class="card-content">
    <label class="card-text">Referral</label>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const authOption = ref([
      { id: 1, label: 'История начислений', param: false },
      { id: 2, label: 'Простые начисления', param: false },
      { id: 3, label: 'Сложные начисления', param: false },
    ]);
