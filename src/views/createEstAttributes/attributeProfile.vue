<template>
  <div class="card-content">
    <label class="card-text">User Profile</label>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const authOption = ref([
      { id: 1, label: 'Аватарка', param: false },
      { id: 2, label: 'Опросник при регистрации', param: false },
      { id: 3, label: 'Дополнительные настройки', param: false },
      { id: 4, label: 'Фото галерея', param: false },
      { id: 5, label: 'Видео галерея', param: false },
      { id: 6, label: 'Социальные сети', param: false },
    ]);
